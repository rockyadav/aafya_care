                            ...
                            <form action="{{ route('login') }}" method="post">
                                ...
                                <div class="card card-login card-hidden">
                                    ...
                                    <div class="card-header text-center" data-background-color="" style="">
                                        <img src="{{url('public/front-assets/assets/images/logo-dark.png')}}" class="logo_new">
                                    ...
                                    <div class="footer text-center">
                                        <button type="submit" class="btn btn-rose btn-simple btn-wd btn-lg" style="border: 1px solid;">Login</button>
                                    </div>
                                </div>
                            </form>
                        </div>

                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="regi-side">
                                ...
                                <form class="register-form" id="register-form" method="post" action="{{url('save-signup')}}">
								 {{ csrf_field() }}
								  <div class="row">
                                     <div class="col-md-6">
										<label class="input-label">Full Name <span class="req">*</span></label>
										<input class="custom-placeholder" type="text" name="name" value="{{old('name')}}" required="">
									   @if ($errors->has('name'))
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="custom-placeholder" type="password" name="password_repeat" required="">
                                        ...
                                        <div class="col-md-8">
                                            <div class="margin-space">
                                                <span data-type="selectors" data-name="birthday_wrapper">
                                                    ...
                                                    <br>
                                                    <span>
                                                        <select name="birthday_day" class="date" required="">
                                                        ...
                                                        <select name="birthday_year" class="date" required="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input class="custom-placeholder" type="text" name="city" value="{{old('city')}}" required="">
											@if ($errors->has('city'))
											 <span class="error-block">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="custom-placeholder" value="{{old('country')}}" type="text" name="country" required="">
                                    ...
                                    <input class="custom-placeholder" type="text" name="address" value="{{old('address')}}" required="">

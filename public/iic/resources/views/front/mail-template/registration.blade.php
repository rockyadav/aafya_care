    ...
    <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">         
        <div class="col num12" style="min-width: 320px;max-width: 500px;display: table-cell;vertical-align: top;">
          ...
          <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
            ...
            <div style="line-height:30px;font-size:1px">&#160;</div>  <img class="center  autowidth  fullwidth" align="center" border="0" src="{{$user['logo']}}" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 440px;background: #000;" width="440">
            <div style="line-height:30px;font-size:1px">&#160;</div>
            </div>

               <p>Hello!</p>

              <p>Welcome on Fotographia!</p>
                 
              <div class="">
                <div style="color:#5ACEE1;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:120%; padding-right: 0px; padding-left: 0px; padding-top: 0px; padding-bottom: 5px;"> 
                  <div style="font-size:12px;line-height:14px;color:#5ACEE1;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center"><span style="font-size: 18px; line-height: 21px;"><strong><span style="line-height: 21px; font-size: 18px;">To verify your mail id<a href="{{$user['link']}}"> Click here </a></span></strong></span></p></div>  
                </div>
              </div>
                  <p>I hope you find what you are looking for and if you have any questions submit a support ticket and we'll be happy to help you out.

                  <p>Best wishes,</p>

                  <p>Team-Fotographia.com</p> 
              </div>
              </div>
            </div>
        </div>

            ...
            <div class="col-md-8">
                <div class="card">  
                    ...
                    <div class="card-content">
                        ...
                        <form method="post" action="{{url('profile-update')}}" onsubmit="return pasCheck()">
                            {{csrf_field()}}  
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group label-floating{{ $errors->has('name') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control txt_Space" name="name"  value="{{$data['user']->name}}" required="">
                                        </div>
                                        @if ($errors->has('name')) 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group label-floating{{ $errors->has('username') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control txt_Space" name="username" required="" value="{{$data['user']->username}}">
                                    </div>
                ...
                <div class="card card-profile">
                    <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                        <div class="fileinput-new thumbnail img-circle">
                            @if($data['user']->image!='')
                            <img src="{{url('public/assets/photos/'.$data['user']->image)}}" alt="image">
                            @else 
                        ...
                        <div>
                            <form id="change-image" action="{{url('change-image')}}" method="post" enctype="multipart/form-data"> 
                                {{csrf_field()}}

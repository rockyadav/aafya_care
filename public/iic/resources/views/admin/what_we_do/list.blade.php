                ...
                <div class="card-content">
                    ...
                    <div class="material-datatables">
                        ...
                        <div class="add-more text-right">
                            ...
                            <a class="btn btn-rose btn-fill" href="{{route('whatwedo.create')}}">Add<div class="ripple-container"></div></a>
                        ...
                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <td class="td-actions">
                                        ...
                                        <a href="{{url('whatwedo/edit/'.$row->id)}}"><button type="button" rel="tooltip" class="btn btn-success">
...

{
    ...
    buttonsStyling: false
        ...
        $.ajax({
                ...
                url: base_url+'/whatwedo-destroy/'+id,

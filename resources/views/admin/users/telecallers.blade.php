...
@section('page-title','Telecallers')
                        ...
                        <table id="userdatatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="td-actions">
									 <a href="{{url('admin/telecaller-details/'.$row->id)}}">
  ...
  function changeStatus(id){
    var id = id;
        ...
        buttonsStyling: false
                ...
                $.ajax({
                    url: '{{ url('/') }}' + '/admin/telecallerChangeStatus/' + id, 
                    method:"get",
...

{
    ...
    buttonsStyling: false
        ...
        $.ajax({
                url: base_url+'/admin/telecallerDestroy/'+id,
                method:"get", 
            success:function(data)
            {
                if(data=='success')
                {
                    ...
                    demo.showNotification('bottom','right','success', message );
                    $('#userdatatables').load(document.URL +  ' #userdatatablesss');
                }else{

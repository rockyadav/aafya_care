...
@section('page-title','Telecaller details')
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card-header card-header-icon" data-background-color="green">
                    ...
                    <a href="{{url('admin/telecallers')}}"> <button type="button" class="btn btn-rose" style="margin: -20px 15px 0;">Back<div class="ripple-container"></div></button></a>
                    </div>
                    <div class="card-content">
                        <h4 class="card-title">Telecaller Details</h4>

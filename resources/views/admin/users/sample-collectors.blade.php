...
@section('page-title','sample-collectors')
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <h4 class="card-title">Sample Collectors</h4>
                    ...
                    <div class="material-datatables">
                        ...
                        <table id="userdatatablesss" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <a class="changeStatus" href="#" data-toggle="tooltip" title="Change Status" id="{{ $row->id }}" onclick="changeStatus({{ $row->id }})" >
                                 @if (($row->status) == '1')
                                    <div class="btn btn-success btn-sm">Active
                                    </div>
                                 @else
                        ...
                        <td class="td-actions">
									 <a href="{{url('admin/sample-collector-details/'.$row->id)}}">
...
function changeStatus(id){
    var id = id;
        ...
        buttonsStyling: false
                ...
                $.ajax({
                    url: '{{ url('/') }}' + '/admin/sampleCollectorChangeStatus/' + id, 
                    method:"get",
...

{
    ...
    buttonsStyling: false
        ...
        $.ajax({
                url: base_url+'/admin/sampleCollectorDestroy/'+id,
                method:"get", 
            success:function(data)
            {
                if(data=='success')

                ...
                <div class="card-content">
                    ...
                    <div class="material-datatables">
                        ...
                        <div class="add-more text-right">
                            ...
                            <a class="btn btn-rose btn-fill" href="{{route('city.create')}}">Add<div class="ripple-container"></div></a>
                        ...
                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <td class="td-actions">
                                        ...
                                        <a href="{{url('admin/city/edit/'.$row->id)}}"><button type="button" rel="tooltip" class="btn btn-success"> <i class="material-icons">edit</i></button></a>

                                        <a href="javascript:void(0);" onclick="deleteData('{{$row->id}}');">
                                        <button type="button" rel="tooltip" class="btn btn-danger"><i class="material-icons">close</i></button></a>
...
function deleteData(id)
{
    ...
    buttonsStyling: false
        ...
        $.ajax({
                ...
                url: base_url+'/admin/city-destroy/'+id,

     ...
     <div class="row"> 
         ...
         <div class="col-md-12">
             ...
             <div class="card">
                    ...
                    {{ Form::open(array('url'=>route('course.store'), 'files'=>true)) }}
                                ...
                                <label class="col-sm-1 label-on-left">Name</label>
                                 <div class="col-sm-11">
                                     <div class="form-group label-floating is-empty">
                                         ...
                                         <input type="text"  class="form-control" name="course_name" placeholder="Enter name" required="" value="{{old('course_name')}}">
							 ...
							 <div class="col-md-6">
                                <label class="col-sm-2 label-on-left">Price</label>
                                 <div class="col-sm-10">
                                     <div class="form-group label-floating is-empty">
                                         <label class="control-label"></label>
                                         <input type="number" min="0" class="form-control" name="price" placeholder="Enter price" required="" value="{{old('price')}}">
                                         @if ($errors->has('price'))
                                             <span class="error-block">
							 ...
							 <div class="col-md-6">
                                <label class="col-sm-4 label-on-left">Discount Price</label>
                                 <div class="col-sm-8">
                                     <div class="form-group label-floating is-empty">
                                         <label class="control-label"></label>
                                         <input type="number" min="0" class="form-control" name="dis_price" placeholder="Enter discount price" required="" value="{{old('dis_price')}}">

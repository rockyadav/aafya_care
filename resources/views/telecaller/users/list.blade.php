                        ...
                        <table id="userdatatablesss" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="td-actions">
									 <a href="{{url('admin/telecaller-customer-details/'.$row->id)}}">
                                            <button type="button" rel="tooltip" class="btn btn-success btn-sm" data-original-title="View" title="">
                                                <i class="material-icons">visibility</i>
                                            <div class="ripple-container"></div></button>
                                        </a> 
										
										<a href="{{url('admin/telecaller-customer-edit/'.$row->id)}}"><button type="button" rel="tooltip" class="btn btn-success" data-original-title="" title="">

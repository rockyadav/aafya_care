...
<body> 
    <div class="wrapper">
        ...
        <div class="logo logo-dash text-center">
            ...
            <a href="{{url('admin/dashboard')}}" class="simple-text logo-normal"> <h4><b>Laboratory</b></h4>
        ...
        <div class="sidebar-wrapper">
            <div class="user">
                ...
                <div class="info">
                    ...
                    <div class="collapse" id="collapseExample">
                        <ul class="nav">
                            <li>
                                <a href="{{url('admin/laboratory-profile')}}">
            ...
            <li class="@if($page=='laboratory-customers' ||  $page=='laboratory-customer-details' || $page=='laboratory-generate-report') active @endif">
                <a href="{{url('admin/laboratory-customers')}}">
            ...
            <!-- <li class="@if($page=='subject' || $page=='subject-add' || $page=='subject-edit') active @endif">
            ...
            <li class="@if($page=='plan' || $page=='plan-add' || $page=='plan-edit' || $page=='plan' ) active @endif">
             ...
             <li class="@if($page=='scheduler' || $page=='scheduler-add' || $page=='scheduler-edit' ) active @endif">
             ...
             <li class="@if($page=='discount' || $page=='discount-add' || $page=='discount-edit' ) active @endif">
            ...
            <li class="@if($page=='discount-coupon' || $page=='discount-coupon-add' || $page=='discount-coupon-edit' ) active @endif">
                <a href="{{url('admin/discount-coupon')}}">
                    <i class="material-icons">receipt</i>
            ...
            <li class="@if($page=='contacts') active @endif">

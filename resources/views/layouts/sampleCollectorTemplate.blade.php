...
<body> 
    <div class="wrapper">
        ...
        <div class="logo logo-dash text-center">
            ...
            <a href="{{url('admin/dashboard')}}" class="simple-text logo-normal"> <h4><b>Sample Collector</b></h4>
        ...
        <div class="sidebar-wrapper">
            <div class="user">
                ...
                <div class="info">
                    ...
                    <div class="collapse" id="collapseExample">
                        <ul class="nav">
                            <li>
                                <a href="{{url('admin/sample-collector-profile')}}">
            ...
            <li class="@if($page=='sample-collector-customers' || $page=='sample-collector-customer-details') active @endif">

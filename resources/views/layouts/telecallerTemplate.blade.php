...
<body> 
    <div class="wrapper">
        ...
        <div class="logo logo-dash text-center">
            ...
            <a href="{{url('admin/dashboard')}}" class="simple-text logo-normal"> <h4><b>Telecaller</b></h4>
        ...
        <div class="sidebar-wrapper">
            <div class="user">
                ...
                <div class="info">
                    ...
                    <div class="collapse" id="collapseExample">
                        <ul class="nav">
                            <li>
                                <a href="{{url('admin/telecaller-profile')}}">
            ...
            <li class="@if($page=='telecaller-customers' ||  $page=='telecaller-customer-details') active @endif">
                <a href="{{url('admin/telecaller-customers')}}">
